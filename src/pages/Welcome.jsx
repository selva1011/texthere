    ...
    <section className="bg-back-1 w-full px-8">
      <div className="h-screen flex items-center justify-center">
        <div className="border-2 border-gray-300 rounded-2xl p-5 w-96">
          ...
          <a href="/register">
            <button className="hover:bg-green-400 bg-green-500  text-white text-sm font-bold rounded-2xl w-full py-3 mt-7 border-b-4 border-b-green-600 text-center hover:cursor-pointer">
              NNNNN
            </button>
          </a>
          <Link to="/register">
